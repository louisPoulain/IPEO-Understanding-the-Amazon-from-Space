...
def get_data():
    if not os.path.exists("drive/MyDrive/Colab_Notebooks/Observation-earth/IPEO_Planet_project.zip"):
            ...
            urllib.request.urlretrieve("https://drive.google.com/file/d/1zS6wtrRfTeLaHwlS0HDlNiAc_b_ZrTeX/view?usp=share_link",
                                       "drive/MyDrive/Colab_Notebooks/Observation-earth/IPEO_Planet_project.zip")
    with zipfile.ZipFile("drive/MyDrive/Colab_Notebooks/Observation-earth/IPEO_Planet_project.zip", 'r') as zip_ref:
        zip_ref.extractall()
